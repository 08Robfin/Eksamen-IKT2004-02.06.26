...
## Database
Databasen er satt opp som en docker container, denne containeren fungerer fint fordi den kan lettes sendes rundt og vil virke på alle maskiner. Det er en Postgres container på port 5432. Denne bør settes opp på en server som er 24/7 og passordet burde endres og fjernes fra kildekoden.
